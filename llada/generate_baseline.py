...
def get_num_transfer_tokens(block_mask_index: torch.Tensor, steps: int) -> torch.Tensor:
    ...
    Returns:
        (B, steps) int – how many tokens to transfer at each step per batch item
    """
...
def get_transfer_index(
    ...
    """
    Vectorized version: returns proposed tokens and which positions to update.
...
def main():
    ...
    out_ids, nfe_history = generate(model, input_ids, steps=32, gen_length=256, block_length=16, temperature=0., remasking='low_confidence', threshold=0.9)
